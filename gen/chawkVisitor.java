...
public interface chawkVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link chawkParser#selection_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelection_statement(chawkParser.Selection_statementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRelationalExpression(chawkParser.RelationalExpressionContext ctx);
	/**
